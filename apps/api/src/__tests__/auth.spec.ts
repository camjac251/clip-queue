...
describe('auth.ts', () => {
  ...
  describe('checkChannelRole', () => {
    it('identifies broadcaster correctly', async () => {
      ...
      const result = await checkChannelRole('client_id', '12345', 'broadcaster', 'user_token')
    ...
    it('caches role checks', async () => {
      ...
      const result1 = await checkChannelRole('client_id', '12345', 'broadcaster', 'user_token')
      const result2 = await checkChannelRole('client_id', '12345', 'broadcaster', 'user_token')
  ...
  describe('authenticate middleware', () => {
    ...
    it('rejects requests without token', () => {
      authenticate(req as AuthenticatedRequest, res as unknown as ExpressResponse, next)
  ...
  describe('requireBroadcaster middleware', () => {
    ...
    it('allows broadcasters', () => {
      ...
      requireBroadcaster(req as AuthenticatedRequest, res as unknown as ExpressResponse, next)
  ...
  describe('requireModerator middleware', () => {
    ...
    it('allows moderators', () => {
      ...
      requireModerator(req as AuthenticatedRequest, res as unknown as ExpressResponse, next)
